#!/usr/bin/env python3
"""Prepared/evaluation audit for the frozen EndpointRemover RORD-280 run."""
...
def load_base_audit() -> Any:
    spec = importlib.util.spec_from_file_location("endpoint_rord280_base_audit", BASE_AUDIT)
