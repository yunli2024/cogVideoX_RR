...
case "${SHARD}" in
  0)
    GPU_ID=4
    SHARD_SHA256=2a127c0e70da8ff7a4cf7c949a29e18c109afbb2f3425199159f16ccb3111538
    ;;
  1)
    GPU_ID=5
    SHARD_SHA256=49b48c01fab6cc333aa8cff7cb5a620613eb75c22275973f29bfcb4c35af1f0a
    ;;
  2)
    GPU_ID=6
    SHARD_SHA256=30e74450ed42712766a609dfddf1c1850e848d363ac4c30bd489dde2894ba1b5
    ;;
  3)
    GPU_ID=7
    SHARD_SHA256=5c2a2b6d491d86705716e2c4dd5fcc02d4ee8d5beda4b32d370f77ebf3956ceb
    ;;
  *)
