...
RUN_ID=run-20260807-213312-dc282ad3
PROTOCOL_ID=orp-db9bb654e8161e9b
GPU_ID=7

CWD=/mnt/cpfs/jiachengliu/code/CogKit
PYTHON=/mnt/cpfs/jiachengliu/envs/cogkit-py310-cu124/bin/python
INFER=${CWD}/quickstart/scripts/rolloutremover_cogvideox/infer_explicit_scheduler_v2.py
...
OUTPUT=/mnt/cpfs/jiachengliu/dataset/CORNE/inference/cogkit_rr_rord280_dpm_smoke_v1/${RUN_ID}/checkpoint-2200
LOG=/mnt/cpfs/jiachengliu/dataset/CORNE/logs/cogkit_rr_rord280_dpm_smoke_v1/${RUN_ID}.log
...
test -f "${CONTRACT}"
test -f "${MANIFEST}"
test -f "${CACHE}/00000211.pt"
test -f "${CACHE}/00000211.json"
test ! -e "${OUTPUT}"
test ! -e "${LOG}"
